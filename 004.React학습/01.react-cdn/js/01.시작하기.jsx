...
/* 
    ...
    -> 그런데 이런 불필요한 태그 구조를 원치 않는 경우
       <React.Fragment></React.Fragment>를 사용하면 내보낼때 하나로 묶는 역할만 하고 실제로 출력 안됨!
    * [참고]
    CLI 환경에서는 빈 태그 <></> 를 대신 사용 가능함
...
function MyFirstReact() {
  ...
  return (
    <React.Fragment>
      ...
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRd0NLTt87luqpRwj6Md2WB0oZ4K-6hGj7jP1sZv0eD0A&s" alt="리액트로고" />
      <h2>
        [리액트란 무엇인가?]
        <br />
