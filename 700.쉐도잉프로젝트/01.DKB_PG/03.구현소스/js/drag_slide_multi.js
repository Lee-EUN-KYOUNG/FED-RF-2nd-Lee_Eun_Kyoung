...
function slideFn(selEl) {
 ...
 /// 슬라이드 버튼 부모 박스에 클래스 right 넣기
 // parentElement는 선택 요소의 직계 부모 요소를 선택한다.
