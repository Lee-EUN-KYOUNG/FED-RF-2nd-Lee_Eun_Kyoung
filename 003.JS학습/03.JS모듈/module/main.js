...
// --> 모듈용 전용 객체에 저장하여 객체.변수명 으로 사용함
import * as txtData from "./text_data.js";

// 불러온 값 확인
/* console.log(myFn,mTitle,sTitle,personInfo,mvData); */
// console.log(myFn, mTit, sTit, pInfo, mdt);
console.log(txtData, txtData.mTitle, txtData.myObj, txtData.myFunc('개발자'));

// export default로 내보낸 단일 함수 불러오기
// import makeMessage from "./msgFormat.js";
import makeMsg from "./msgFormat.js";
...
console.log(titBox, contBox, mvBox);
